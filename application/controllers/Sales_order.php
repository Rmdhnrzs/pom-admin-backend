...
class Sales_order extends CI_Controller {
	...
	public function index()
	{
		// $data['view'] = 'home';
		// $data['title'] = 'Home';
		// $data['nama_perusahaan'] = $this->session->userdata('nama_perusahaan');
		...
		redirect(base_url($this->config->item('frontend_host').'/app'));
	}
	...
	// 	$data['produk'] = $this->db->query("SELECT id, kode_artikel, nama_artikel, satuan, $tipe as harga, size from tb_barang where $tipe > 0 and deleted_at is null and id_perusahaan = '$perusahaan_id' order by kode_artikel")->result();
	// 	$this->load->view('mobile/header.php',$data);
	// 	$this->load->view('mobile/mobile.php',$data);
	// 	$this->load->view('mobile/footer.php');
	// }
